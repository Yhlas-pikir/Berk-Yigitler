...
function ItemPage() {
  return (
    <div  style={{display:'flex', flexDirection:"column",minHeight: "100vh"}}>
        <Navbar/>
        <div style={{display:"flex", flexDirection:"column", width:"90%", alignSelf:"center", marginTop:"20px"}}>
          <h2 style={{textAlign:"left",marginBottom:10}}>Name</h2>
          <p style={{fontSize: 20}}>1. asdas</p>
          <p style={{fontSize: 20}}>1. asdas</p>
          <p style={{fontSize: 20}}>1. asdas</p>
          <p style={{fontSize: 20}}>1. asdas</p>
          <p style={{fontSize: 20}}>1. asdas</p>
